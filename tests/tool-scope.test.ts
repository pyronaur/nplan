...
void test("getToolsForPhase adds discovery helpers and the submit tool during planning", () => {
...
void test("getToolsForPhase strips planning-only tools outside planning", () => {
